...
export const listarPerfis = () =>
  requisitar<Perfil[]>('/usuarios/perfis')

export const criarUsuario = (dados: object) =>
  requisitar<Usuario>('/usuarios', {
    method: 'POST',
    body: JSON.stringify(dados),
  })

export const editarUsuario = (id: number, dados: object) =>
...
export const excluirUsuario = (id: number) =>
  requisitar<void>(`/usuarios/${id}`, {
    method: 'DELETE',
  })

export const listarManuais = () => requisitar<Manual[]>('/manuais')

export const criarManual = (dados: object) =>
  requisitar<Manual>('/manuais', {
    method: 'POST',
    body: JSON.stringify(dados),
  })

export const editarManual = (id: number, dados: object) =>
  requisitar<Manual>(`/manuais/${id}`, {
    method: 'PUT',
    body: JSON.stringify(dados),
  })

export const excluirManual = (id: number) =>
  requisitar<void>(`/manuais/${id}`, {
    method: 'DELETE',
  })
...
export function enviarArquivo(
  ...
  return requisitar(`/manuais/${id}/arquivo?substituir=${substituir}`, {
    method: 'POST',
    body: dados,
  })
}
